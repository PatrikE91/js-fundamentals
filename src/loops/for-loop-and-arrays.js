...
function everySecondNumFN(arr, num) {
  const everySecondNum = []

  for (let i = 1; i < arr.length; i += num) {
    everySecondNum.push(arr[i])
  }
  return everySecondNum
}
console.log(everySecondNumFN(nums, 2))
const everySecondNum = everySecondNumFN(nums, 2)
